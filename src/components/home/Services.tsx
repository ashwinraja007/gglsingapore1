...
const EnhancedServiceCard = ({
  ...
  const serviceImages: Record<string, string> = {
    "Air Freight": "/lovable-uploads/airfreight.jpg",
    "Ocean Freight": "/lovable-uploads/oceanfreight.jpg",
    "Customs Clearance": "/lovable-uploads/cc.jpg",
    "Liquid Transportation": "/lovable-uploads/liquid.jpg",
  };
  ...
  const services = [
    {
      ...
      title: "Air Freight",
      description:
        "Tailored Air Freight Solutions to Meet Your Unique Requirements. We offer flexible air freight solutions for time-sensitive documents or large-scale cargo.",
    ...
    },
    {
      ...
      title: "Ocean Freight",
      description:
        "Connecting you globally with comprehensive ocean freight services. We offer both LCL for smaller shipments and FCL for dedicated container needs.",
      icon: <Anchor size={20} />,
    ...
    },
    {
      ...
      description:
        "Expert customs clearance services ensuring your shipments move smoothly across borders with accurate documentation and regulatory compliance.",
      icon: <Truck size={20} />,
    ...
    },
    {
      ...
      description:
        "Specialized solutions for transporting liquids safely and efficiently, utilizing ISO tanks, flexitanks, and specialized tankers managed by expert teams.",
        ...
        <motion.div variants={itemVariants} transition={{ duration: 0.6, delay: 0.4 }} className="flex justify-center mt-8">
          <Link to="/services" onClick={() => window.scrollTo(0, 0)}>
            <Button variant="navy" className="group transition-all duration-300 text-sm flex items-center gap-2 navy-glow">
              ...
              <motion.span animate={{ x: [0, 5, 0] }} transition={{ duration: 1.5, repeat: Infinity, repeatType: "mirror" }}>
