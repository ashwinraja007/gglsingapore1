...
import { Users, UserCircle, SearchCode, Ship, Calendar, Globe, Briefcase } from 'lucide-react';
        ...
        <div className="container mx-auto h-full flex items-center px-4 md:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              Delivering Excellence for <span className="text-yellow-500">UK</span> Supply Chains
            </h1>
