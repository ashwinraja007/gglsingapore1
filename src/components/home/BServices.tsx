  ...
  const services = [
    {
      ...
      icon: <Anchor />,
      link: "/bangladesh/services/ocean-freight"
    },
    {
      image: "/hom4.png",
      ...
      icon: <Warehouse />,
      link: "/bangladesh/services/lcl-consolidation"
    },
    {
      image: "/hom3.png",
      ...
      icon: <Truck />,
      link: "/bangladesh/services/transportation"
    },
    {
      ...
      icon: <Warehouse />,
      link: "/bangladesh/services/warehousing"
    },
    {
      image: "/aircargo1.png",
      title: "Air Freight",
      ...
      icon: <Plane />,
      link: "/bangladesh/services/air-freight"
    },
    {
      image: "/cargoh1.png",
      title: "Project Cargo",
      ...
      icon: <Warehouse />,
      link: "/bangladesh/services/project-cargo"
    }
  ];
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <Link to="/bangladesh/services" onClick={() => window.scrollTo(0, 0)}>
