...
const GlobalPresence = () => {
  ...
  return <motion.section initial="hidden" whileInView="visible" viewport={{
    once: true,
    amount: 0.2
  }} variants={containerVariants} className="py-12 bg-brand-navy text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="relative w-full h-[280px] sm:h-[350px] md:h-[450px] rounded-xl overflow-hidden bg-brand-navy shadow-xl border border-brand-gold/20">
            <div className="absolute inset-0 bg-[url('/lovable-uploads/globalpresence1.png')] bg-contain bg-center bg-no-repeat opacity-50"></div>
            ...
            y: -5
                ...
                repeat: Infinity
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 top-3 min-w-max px-2 py-1 bg-white/10 backdrop-blur-sm rounded text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
            ...
            <svg className="absolute inset-0 w-full h-full z-0 opacity-30">
              <motion.path d="M170,140 C250,100 350,120 430,180 C510,240 600,200 680,150" stroke="#D4AF37" strokeWidth="1" fill="none" initial={{
              pathLength: 0,
              opacity: 0
            }} animate={{
              pathLength: 1,
              ...
              <motion.path d="M250,170 C350,220 450,180 550,120" stroke="#D4AF37" strokeWidth="1" fill="none" initial={{
              pathLength: 0,
              opacity: 0
            }} animate={{
              pathLength: 1,
              ...
              <motion.path d="M150,180 C300,230 500,230 650,180" stroke="#D4AF37" strokeWidth="1" fill="none" initial={{
              pathLength: 0,
              opacity: 0
            }} animate={{
              pathLength: 1,
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            ...
            once: true
          }} className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-center border border-brand-gold/10">
