          ...
          delay: 0.2
            ...
            delay: 1.1
              ...
              scale: 0.97
                ...
                <Button variant="gold" size="lg" className="w-full sm:w-auto font-semibold shadow-lg hover:shadow-xl transition-all duration-300 gold-glow bg-[#d4af37] text-sm sm:text-base">
                  Get A Quote
                </Button>
              </motion.a>
