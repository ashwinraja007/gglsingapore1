            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              {portalLinks.map((link, index) => <div key={index} className="flex flex-col items-center">
                  {link.external ? <a href={link.url} target="_blank" rel="noopener noreferrer" className="w-full">
                      <Button variant="outline" className="w-full h-16 flex flex-col gap-1 items-center justify-center text-xs sm:text-sm border-brand-gold text-brand-gold hover:bg-brand-gold hover:text-brand-navy transition-colors">
                        {link.icon}
                        <span className="font-medium text-gray-950">{link.title}</span>
                      </Button>
                    </a> : link.onClick ? <Button variant="outline" className="w-full h-16 flex flex-col gap-1 items-center justify-center text-xs sm:text-sm border-brand-gold text-brand-gold hover:bg-brand-gold hover:text-brand-navy transition-colors" onClick={link.onClick}>
                      {link.icon}
                      <span className="font-medium text-gray-950">{link.title}</span>
