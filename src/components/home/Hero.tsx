        ...
        <div className="hidden md:grid grid-cols-3 lg:grid-cols-5 gap-2 lg:gap-3">
          {portalLinks.map((link, index) => (
            ...
            >
              <Link 
                to={link.url} 
                className="w-full h-full p-3 flex flex-col items-center justify-center space-y-2 text-white"
              >
                <motion.span 
                  className="text-brand-gold transform transition-transform p-2 bg-white/5 rounded-full"
