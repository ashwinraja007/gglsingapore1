    ...
    <section className="relative min-h-screen overflow-hidden pt-8 md:pt-16">
      ...
      <div className="absolute inset-0 flex items-center z-[2]">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className={`max-w-2xl space-y-4 md:space-y-5 text-left transition-all duration-800 ${
      ...
      <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-0 right-0 z-10 px-2 sm:px-4">
        <div className={`max-w-7xl mx-auto transition-all duration-800 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
        }`}>
          {/* REMOVED border border-white/20 - No more white border! */}
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 sm:p-4 shadow-2xl">
