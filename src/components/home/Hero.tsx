...
export const Hero = () => {
  ...
  return <section className="relative min-h-screen overflow-hidden">
      ...
      delay: 1.3
        ...
        <motion.button className="md:hidden w-full bg-brand-navy/80 backdrop-blur-md p-4 rounded-lg shadow-lg mb-4 flex items-center justify-between text-white border border-white/20" onClick={() => setIsMenuOpen(!isMenuOpen)} whileHover={{
        scale: 1.02
      }} whileTap={{
        scale: 0.98
      }}>
        ...
        <div className="hidden md:grid grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          y: -5,
          scale: 1.02
        }} className="bg-white/10 backdrop-blur-md rounded-lg hover:bg-white/20 transition-all duration-300 group border border-white/10">
