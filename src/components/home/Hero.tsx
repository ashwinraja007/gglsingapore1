              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full sm:w-auto">
                <Link to="/contact">
                  <Button 
                    variant="gold" 
                    size="lg" 
                    className="w-full shadow-lg hover:shadow-xl transition-all duration-300 gold-glow py-0 rounded-md my-[3px] font-bold px-[17px] mx-0 border-0"
                  >
                    Get A Quote
                  </Button>
                </Link>
                ...
                <div key={index} className="flex flex-col items-center">
                  {link.external ? (
                    <a href={link.url} target="_blank" rel="noopener noreferrer" className="w-full">
                      <Button 
                        variant="outline" 
                        className="w-full h-16 flex flex-col gap-1 items-center justify-center text-xs sm:text-sm border-brand-gold text-brand-gold hover:bg-brand-gold hover:text-brand-navy transition-colors border-0"
                      >
                        {link.icon}
