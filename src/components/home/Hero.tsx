...
const Hero = () => {
  ...
  const sliderImages = ["/homeimage.jpg", "/truck.png", "/ships.png", "/cargoplane.png"];
...
<div className="absolute inset-0 flex items-start justify-start z-[2] pt-15"> {/* Adjust pt-20 as needed */}
