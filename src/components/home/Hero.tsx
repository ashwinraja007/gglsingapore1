  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-16">
            ...
            >
              ...
              >
                <Button 
                  variant="gold" 
                  size="lg" 
                  className="font-semibold shadow-lg hover:shadow-xl transition-all duration-300 gold-glow bg-[#d4af37]"
                >
                  Get A Quote
                </Button>
              </motion.a>
              ...
              >
                <Link to="/services">
                  <Button 
                    size="lg" 
                    variant="outline" 
                    className="font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-white border-white hover:bg-white/20"
                  >
                    Our Services
                  </Button>
                </Link>
      ...
      >
        ...
        <motion.button 
          className="md:hidden w-full bg-brand-navy/90 backdrop-blur-md p-4 rounded-lg shadow-lg mb-4 flex items-center justify-between text-white border border-brand-gold/30" 
          ...
          {portalLinks.map((link, index) => (
            ...
            >
              <Link to={link.url} className="w-full h-full p-3 flex flex-col items-center justify-center space-y-2 text-white">
                <motion.span 
                  className="text-brand-gold transform transition-transform" 
                  animate={{ y: [0, -5, 0] }}
