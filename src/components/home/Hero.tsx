...
export const Hero = () => {
  ...
  return <section className="relative min-h-screen overflow-hidden pt-16">
          ...
          delay: 0.2
            ...
            delay: 1.1
              ...
              scale: 0.97
                ...
                <Link to="/services">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-white border-white hover:bg-white/20 text-sm sm:text-base">
                    Our Services
                  </Button>
                </Link>
              </motion.div>
      ...
      delay: 1.3
        ...
        <motion.button className="md:hidden w-full bg-brand-navy/90 backdrop-blur-md p-3 rounded-lg shadow-lg mb-3 flex items-center justify-between text-white border border-brand-gold/30" onClick={() => setIsMenuOpen(!isMenuOpen)} whileHover={{
        scale: 1.02
      }} whileTap={{
        scale: 0.98
      }}>
        ...
        <div className="hidden md:grid grid-cols-3 lg:grid-cols-5 gap-2 lg:gap-3">
          ...
          scale: 1.02
              ...
              <Link to={link.url} className="w-full h-full p-3 flex flex-col items-center justify-center text-white">
                <motion.span className="text-brand-gold transform transition-transform p-2 bg-white/5 rounded-full mb-2" whileHover={{
              scale: 1.1,
              rotate: 10
            }} animate={{
              y: [0, -3, 0]
