      ...
      <main className="flex-grow pt-20">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-neutral-50">
                Join Our Pakistan Team
              </h1>
              <p className="text-xl mb-8 text-blue-100">
                Build your career with GGL Pakistan. 
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl font-bold text-brand-navy mb-4">Why Choose GGL Pakistan?</h2>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="w-24 h-1 bg-brand-gold mx-auto mb-6"></div>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Explore exciting career opportunities across our Karachi and Lahore offices.
              </p>
            </motion.div>
