...
const ServiceCard = ({ icon, title, description, image, link, id }: any) => {
  const getServiceImage = () => {
    switch (title) {
      ...
      case "Transportation": return "/mtransport.png";
      case "Warehousing": return "/mwarehouse.png";
...
const MalaysiaServices = () => {
  ...
  const services = [
    ...
    { id: 4, htmlId: "warehousing", icon: <Warehouse className="w-5 h-5" />, title: "Warehousing", image: "/mwarehouse.png", description: "We offer full-service warehousing and third-party logistics (3PL) to streamline your supply chain with flexible, reliable, and scalable solutions.", link: `${navPaths.services}/warehousing` },
