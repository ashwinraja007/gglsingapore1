          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-slate-50 drop-shadow">
                GGL Pakistan: Logistics Excellence in Karachi & Lahore
              </h1>
              <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed text-slate-50 drop-shadow">
                Local expertise powered by our global network to keep Pakistan supply chains moving by sea, air, and road.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                  <p>
                    GGL Pakistan blends global reach with local execution. Our team coordinates <strong>LCL consolidation, air freight,</strong> and <strong>domestic distribution</strong> tailored to the Pakistan market.
                  </p>
                  <p>
                    Strategically positioned in <strong>Karachi</strong> and <strong>Lahore</strong>, we connect shippers to worldwide ports through direct weekly sailings and competitive air schedules.
                  </p>
                  <p>
                  ...
                  <p>
                    With modern tracking and documentation support, GGL Pakistan keeps your cargo visible from factory pickup to final delivery.
                  </p>
                </div>
              </motion.div>
