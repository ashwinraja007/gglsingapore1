        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-semibold text-gray-800 mb-8 text-center">ABOUT US</h2>
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              <img 
                ...
                className="rounded-xl shadow-lg w-full max-w-4xl mx-auto object-cover h-[400px]" 
              />
            </motion.div>
          </div>
        </section>
