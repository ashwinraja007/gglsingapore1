        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            once: true
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-4">At GGL, we take pride in being one of Singapore’s premier logistics companies, offering
specialized expertise across warehousing, freight forwarding (air and ocean), and transportation.
Our mission is to provide seamless, end-to-end global logistics solutions through a trusted
network of partners, each excelling in their respective logistics segments.</p>
              <p className="text-gray-700 text-lg leading-relaxed mb-4">Our experienced team is dedicated to delivering world-class service, tailored to meet the unique
needs of each client. Whether it’s a custom-built logistics strategy or a full-spectrum solution, we
ensure efficiency, reliability, and value every step of the way.</p>
              <p className="text-gray-700 text-lg leading-relaxed">To enhance customer experience, GGL leverages a powerful, internet-based software platform
that offers real-time shipment visibility—from origin to destination. This technology ensures
transparency, control, and timely updates, delivering a seamless and differentiated logistics
experience.</p>
            </motion.div>
            <motion.div initial={{
            opacity: 0,
        ...
        <section className="py-20 bg-gray-50 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            }].map((service, idx) => <motion.div key={idx} initial={{
              opacity: 0,
              y: 30
            }} whileInView={{
              opacity: 1,
