        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-700 mb-6 text-justify">GGL is a leading LCL consolidator with a strong global footprint, offering
...
our clients.</p>
              <p className="text-gray-700 mb-6 text-justify">Strategically positioned in major transshipment hubs—Singapore, Malaysia, Sri
...
and cost-effective consolidation services across continents.</p>
              <p className="text-gray-700 mb-6 text-justify">We are excited to announce the launch of GGL’s operations in India, starting with
...
strengthens our regional service capabilities.</p>
            </div>
