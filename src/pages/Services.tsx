...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      stats: [
        { value: "1500+", label: "Vehicles" },
        { value: "45+", label: "Distribution centers" },
        { value: "99.7%", label: "Delivery accuracy" }
      ]
    },
    {
      ...
      stats: [
        { value: "1.2M+", label: "Sq ft of space" },
        { value: "99.9%", label: "Inventory accuracy" },
        { value: "60 min", label: "Average processing" }
      ]
    },
    {
      ...
      stats: [
        ...
        { value: "25K+", label: "Annual shipments" },
      ...
      <main className="flex-grow pt-20">
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <motion.div 
            ...
            className="absolute -bottom-12 -right-12 w-64 h-64 bg-blue-500 rounded-full blur-3xl"
          ></motion.div>
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.1 }}
            transition={{ delay: 0.7, duration: 1 }}
            className="absolute -top-24 -left-24 w-80 h-80 bg-purple-500 rounded-full blur-3xl"
          ></motion.div>
        </section>
              ...
              {services.map((service, index) => (
                ...
                >
                  <div className={`p-3 rounded-full inline-flex mb-4 ${
                    activeService === index ? "bg-white/20" : "bg-blue-100"
                  }`}>
                    {service.icon}
                  </div>
