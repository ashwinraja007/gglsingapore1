  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <Link to={link} className="text-green-600 font-medium hover:text-green-700 inline-flex items-center">
          Learn More
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-24">
        ...
        <section className="py-16">
          <div className="container mx-auto px-[240px]">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="text-center max-w-3xl mx-auto mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose Our Logistics Services?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }} className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow border-l-4 border-green-600">
